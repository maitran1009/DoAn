...
public class PayService {
    ...
    public boolean createPay(HttpSession session, PayInput input) {
        ...
        try {
            ...
            Province province = provinceRepository.findById(Integer.valueOf(input.getWard())).orElse(new Province());
            ...
            for (Cart cart : carts) {
                ...
                orderDetail.setProductDetail(productDetailRepository.findById(cart.getProductDetailId()).orElse(null));
